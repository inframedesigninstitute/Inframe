        ...
        />
                    ...
                    <div className="max-w-[1320px] mx-auto px-3 lg:px-6">
                        <div className="grid md:grid-cols-[72%_auto] gap-10 items-center md:items-start">
                            ...
                            <div className="w-full h-full">
                                {/* Course Info Card */}
                                <div className="bg-white p-10 transition-all duration-300 shadow-[0_0_50px_rgba(0,0,0,0.05)]">
                                    {/* Course Name */}
                                    ...
                                    <div className="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4 mt-4">
                                        <button
                                            onClick={() => addToCart({ itemId: specificCourseData?._id, main: 'online course' })}
                ...
                <section className="">
                    <div className="max-w-[1320px]  mx-auto ">
                        ...
                        {/* recording section */}
                        <section id="recording-section" className="py-[50px]">
