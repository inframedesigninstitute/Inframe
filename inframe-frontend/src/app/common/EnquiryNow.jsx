  ...
  return (
    <form
      ...
      className={`${enquiryModel ? "right-0" : "-right-full"
        } space-y-5 lg:w-[30%] sm:w-[60%] w-[80%] z-40 h-auto mt-5 flex-1 fixed top-1/2 duration-700 -translate-y-1/2 py-7 px-7 rounded-[10px] text-gray-900 bg-white`}
    >
      ...
      <input
        ...
        required
        className="border border-gray-300 w-full rounded-[15px] px-3 py-[10px]"
      ...
      <select
        ...
        required
        className="border border-gray-300 w-full rounded-[15px] px-3 py-[10px] text-gray-500"
      >
      ...
      <button
        type="submit"
        className="w-full rounded-[15px] font-semibold py-3 text-white bg-gray-900 hover:bg-white hover:text-gray-900 border-2 hover:border-gray-900"
      >
        Enquiry Now
      </button>
    </form>
