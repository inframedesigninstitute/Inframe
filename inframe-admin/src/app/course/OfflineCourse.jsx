            ...
            <form onSubmit={addOfflineCourse}>
                ...
                <div className="max-w-6xl mx-auto p-6 shadow-sm bg-white border border-gray-100 rounded-md my-8">
                    ...
                    <section className="mb-8">
                        ...
                        <div className="border  p-5 border-red-200 shadow-sm shadow-red-100 rounded">
                            ...
                            <textarea
                                ...
                                required
                                className="w-full min-h-[100px] border border-gray-300 rounded focus:outline-none px-3 py-2 mb-2"
                            />
                        </div>
                ...
                <button className=" py-3 px-10 bg-gray-950 cursor-pointer text-white rounded-[5px] hover:bg-green-900 duration-300 text-xl capitalize">
